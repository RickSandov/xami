...
export const About = () => {
    ...
    return (
        <section className='p-4 h-[50vh] flex flex-col items-center relative my-10 overflow-y-visible' >
            <div className="z-20">
            ...
            <div ref={discRef} className='w-full md:w-1/2 aspect-square absolute top-1/2 -translate-y-1/2 right-0 translate-x-1/2 z-10'>
                <Image fill src='/disc.png' alt='' className='w-full h-full' />
            </div>
        </section>
    )
}
